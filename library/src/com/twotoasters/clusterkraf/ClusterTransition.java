...
class ClusterTransition {
	...
	private ClusterTransition(Projection projection, ClusterPoint originClusterPoint, InputPoint firstRelevantInputPointFromOriginClusterPoint, ClusterPoint destinationClusterPoint) {
		...
		this.originRelevantInputPointsCluster = new ClusterPoint(firstRelevantInputPointFromOriginClusterPoint, projection, originClusterPoint.getMapPosition());
